...
class FinancialCoachService
{
     ...
     * anonymous agent expects. The response schema is appended to
     * instructions so the model knows the expected JSON shape without
     * relying on provider-side structured output.
     *
     * @param  array<string, mixed>  $context
