...
class UpdateDebtRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return $debt !== null && $debt->user_id === $this->user()->id;
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => ['sometimes', 'required', Rule::in(['credit_card', 'student', 'auto', 'mortgage', 'personal', 'medical', 'other'])],
            'balance' => ['sometimes', 'required', 'numeric', 'decimal:0,2', 'min:0', 'max:999999999.99'],
